...
class __TwigTemplate_9305e6aac4dcb61bf3598ce460fad2b4a4ad9babdbfb16e0649e309398fca7ce extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
      ...
      <div class=\"row\">
        ...
        echo "\"
                                ...
                                <div class=\"row\">
                                  <div class=\"col-12 col-xs-12 col-md-12\">
                                      <a href=\"/register\" class=\"btn btn-outline-warning w-100\">Nieuw op ";
        // line 27
        echo twig_escape_filter($this->env, ($context["hotelnaam"] ?? null), "html", null, true);
        echo "? Registreer hier!</a>
                                  </div>
                              </div>
                            </div>
                        </div>
...
{% block body %}  
      <div class=\"row\">
            <div class=\"col-md-6 mt-3\">
                <div class=\"card\">
                    <div class=\"card-body\">
                        <h4>Welkom op {{hotelname}}!</h4>
                        <hr>
                        <div class=\"row text-left\">
                            <div class=\"col-md-12\">
                                <form action=\"login/request\" method=\"post\" id=\"login\">
                                    <label for=\"username\">Uw gebruikersnaam</label>
                                    <input type=\"text\" name=\"username\" id=\"username\" class=\"form-control {% if validation.geterror('username') %}error{% endif %}\"
                                           placeholder=\"Vul hier uw gebruikersnaam in...\">
                                    <label for=\"password\" id=\"password\" class=\"pt-4\">Uw wachtwoord</label>
                                    <input type=\"password\" name=\"password\" class=\"form-control {% if validation.geterror('password') %}error{% endif %}\"
                                           placeholder=\"Vul hier uw wachtwoord in...\">
                                ...
                                <div class=\"row\">
                                  <div class=\"col-12 col-xs-12 col-md-12\">
                                      <a href=\"/register\" class=\"btn btn-outline-warning w-100\">Nieuw op {{hotelnaam}}? Registreer hier!</a>
                                  </div>
                              </div>
                            </div>
                        </div>
...
{% endblock %}", "Pages/Home/login.html", "/var/www/cosmicproject.nl/Meteor/app/Views/Pages/Home/login.html");
    }
}
