...
/* permissions.html */
class __TwigTemplate_717d65d425293c96c2b40116cca647d37db623b9d0db86c1285340ff8a1c144f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% else %}
    ...
    {% endif %}
{% endif %}", "permissions.html", "/var/www/cosmicproject.nl/Meteor/app/Views/permissions.html");
    }
}
