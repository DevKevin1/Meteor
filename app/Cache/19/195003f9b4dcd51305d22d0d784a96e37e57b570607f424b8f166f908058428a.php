...
/* Pages/Home/me.html */
class __TwigTemplate_578e39d6ad7dd5de1dbe2a8593a560849b0ae6060b65f9ad58262a678389550c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("{% extends \"logged_in.html\" %}
{% block body %}  
        <div class=\"row\">
            <div class=\"col-md-7 mt-5\">
                <div class=\"card\">
                ...
                <div class=\"col-md-12 mt-5 p-0 flex-column\">
                    ...
                    <div class=\"card flex-column mt-3\">
                        <div class=\"card-body\">
                            ...
                            <div class=\"row\">
                                <div class=\"col-md-12\">
                                    <input class=\"form-control p-2\" placeholder=\"https://{{hotelurl}}/invite/{{userInviteId}}\" type=\"text\" name=\"redeem\" readonly>
                                </div>
                                <div class=\"col-md-12 mt-2\">
                                    <button class=\"btn btn-outline-warning w-100\"><i class=\"fa fa-copy\"></i> Clipboard</button>
                                </div>
...
{% endblock %}", "Pages/Home/me.html", "/var/www/cosmicproject.nl/Meteor/app/Views/Pages/Home/me.html");
    }
}
